...
export const az: Catalogue = {
  ...
  calculator: {
    ...
    searchStateHint: 'Ad və ya kod yazın — "AL" da, "Alab" da Alabama-nı tapır.',
    searchBranchHint: 'Filial adının istənilən hissəsini yazın.',
    noMatch: '"{{query}}" üzrə uyğunluq tapılmadı.',
    stepOne: 'Addım 1',
    stepTwo: 'Addım 2',
    routeSummary: 'Marşrut',
  ...
  vehicles: {
    ...
    photos: 'Şəkillər',
    photoHint:
      'JPEG, PNG, WebP və ya AVIF. İstədiyiniz qədər seçin — böyük şəkillər yüklənməzdən əvvəl brauzerinizdə kiçildilir.',
    photoAddMore: 'Daha çox şəkil əlavə et',
    photoSelected_one: '{{count}} şəkil seçildi',
    photoSelected_other: '{{count}} şəkil seçildi',
    photoStatePending: 'Gözləyir',
    photoStateCompressing: 'Kiçildilir…',
    photoStateUploading: 'Yüklənir…',
    photoStateDone: 'Yükləndi',
    photoStateFailed: 'Alınmadı',
    photoCompressedTo: '{{from}} → {{to}}',
    photoRetryFailed: 'Alınmayanları yenidən yüklə',
    photoSummary: '{{total}} şəkildən {{done}} yükləndi, {{failed}} alınmadı.',
    photoRemove: '{{name}} şəklini sil',
    errPhotoHeic:
      '{{name}}: HEIC şəkilləri brauzerdə oxuna bilmir. JPEG kimi ixrac edib yenidən cəhd edin.',
    errPhotoType: '{{name}}: dəstəklənməyən format ({{type}}). JPEG, PNG, WebP və ya AVIF istifadə edin.',
    errPhotoTooLarge:
      '{{name}} {{size}} həcmindədir — kiçildikdən sonra da {{limit}} limitini aşır.',
    ...
    editTitle: 'Avtomobili redaktə et',
    editSubtitle:
      'Daxil etdiyiniz məlumatları düzəldin. Status, məbləğlər və işçilərimizin idarə etdiyi sahələr yalnız oxunur — səhv varsa bizimlə əlaqə saxlayın.',
    adminManagedField: 'İşçilərimiz tərəfindən idarə olunur.',
    loadingVehicle: 'Avtomobil yüklənir…',
    errLoadVehicle: 'Avtomobil yüklənə bilmədi: {{error}}',
    errVehicleNotFound:
      'Bu avtomobil hesabınızda tapılmadı. Silinmiş ola bilər.',
    errUpdate: 'Dəyişiklikləriniz saxlanıla bilmədi: {{error}}',
    errNotUpdated:
      'Dəyişiklikləriniz saxlanılmadı. Verilənlər bazası yeniləməni qəbul etmədi — səhifəni yeniləyib yenidən cəhd edin və ya dəstəklə əlaqə saxlayın.',
    currentPhotos: 'Mövcud şəkillər',
    photoRemoveExisting: 'Sil',
    photoUndoRemove: 'Saxla',
    photoRemovePending_one: 'Saxladıqda {{count}} şəkil silinəcək.',
    photoRemovePending_other: 'Saxladıqda {{count}} şəkil silinəcək.',
    errPhotoRemoveBlocked:
      'Şəkillər silinə bilmədi. Hesabınızın icazəsi olmaya bilər.',
    warnPhotoRemove:
      'Dəyişiklikləriniz saxlanıldı, lakin şəkillər silinə bilmədi: {{error}}',
  },

  cars: {
    title: 'Avtomobillərim',
    subtitle: 'Hesabınızdakı hər avtomobil və onun tam sənədi.',
    loading: 'Avtomobilləriniz yüklənir…',
    loadError: 'Avtomobilləriniz yüklənə bilmədi: {{error}}',
    empty: 'Hələ avtomobiliniz yoxdur.',
    noMatch: 'Bu məkanda avtomobil yoxdur.',
    countLabel: '{{total}} avtomobildən {{shown}}',

    locationFilter: 'Məkan',
    locationAll: 'Hamısı',
    location: {
      Auction: 'Auksion',
      Warehouse: 'Anbar',
    ...
    colCar: 'Avtomobil',
    colDebt: 'Borc',
    colPenalty: 'Auksion cəriməsi',
    colStatus: 'Avtomobilin statusu',
    colOpening: 'Gözlənilən açılış tarixi',
    colImage: 'Şəkil',
    colActions: 'Əməliyyatlar',

    details: 'Ətraflı',
    hideDetails: 'Ətraflını gizlət',
    detailsFor: '{{car}} üçün ətraflı məlumat',
    openGallery: 'Şəkil qalereyasını aç',
    galleryTitle: 'Avtomobil şəkil qalereyası',

    cardCar: 'Avtomobil məlumatı',
    cardAuction: 'Auksion məlumatı',
    cardTransport: 'Nəqliyyat məlumatı',

    car: 'Avtomobil',
    finalPrice: 'Yekun qiymət',
    client: 'Müştəri',
    personalNumber: 'Şəxsiyyət nömrəsi',
    auction: 'Auksion',
    state: 'Ştat',
    city: 'Şəhər',
    loadingPort: 'Yükləmə limanı',
    carrier: 'Daşıyıcı',
    auctionPickupDate: 'Auksiondan götürülmə tarixi',
    warehouseDeliveryDate: 'Anbara çatdırılma tarixi',
    departureDate: 'Yola düşmə tarixi',
    entryDate: 'Giriş tarixi',
    containerNumber: 'Konteyner nömrəsi',
    openDate: 'Açılış tarixi',
    seaLine: 'Dəniz xətti',
    terminal: 'Terminal',
  ...
  photos: {
    ...
    categoryEmpty: 'Şəkil yoxdur',
    changeCategory: '{{index}} nömrəli şəkli başqa kateqoriyaya köçür',
    viewerTitle: '{{vehicle}} şəkilləri',
    openViewer: '{{total}} şəkildən {{index}}-ni aç',
    photoAlt: '{{vehicle}} — {{total}} şəkildən {{index}}',
    counter: '{{index}} / {{total}}',
    ...
    close: 'Bağla',
    loading: 'Şəkillər yüklənir…',
    none: 'Hələ şəkil yoxdur.',
    loadFailed:
      'Bu şəkil yüklənə bilmədi. Keçidin vaxtı bitmiş ola bilər — yenidən cəhd edin.',
