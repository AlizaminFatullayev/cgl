...
export const ru: Catalogue = {
  ...
  home: {
    ...
    whyInsuredTitle: 'Полная страховка',
    whyInsuredBody:
      'Бесплатная страховка покрывает автомобиль от двери до порта — 0%, без доплат.',
  ...
  services: {
    ...
    insuranceBody:
      'БЕСПЛАТНОЕ покрытие от всех рисков от площадки до порта — 0%, без доплат.',
  ...
  about: {
    ...
    p3: 'Наша компания предлагает услуги импорта автомобилей с полной гарантией, БЕСПЛАТНОЙ страховкой и конкурентными ценами на перевозку. В наших ценах нет скрытых или дополнительных сборов.',
  ...
  vehicles: {
    ...
    notes: 'Заметки',
    photos: 'Фотографии',
    photoHint: 'JPEG, PNG, WebP или AVIF. До 10 МБ каждая.',
